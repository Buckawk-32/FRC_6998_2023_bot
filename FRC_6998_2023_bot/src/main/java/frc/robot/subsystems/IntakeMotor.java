...
public class IntakeMotor extends SubsystemBase {
    ...
    public IntakeMotor() {
        ...
        INTAKE_MOTOR_LEFT.restoreFactoryDefaults();
        ...
        INTAKE_MOTOR_LEFT.getEncoder().setVelocityConversionFactor(1/15);
        ...
        INTAKE_MOTOR_RIGHT.follow(INTAKE_MOTOR_LEFT, true);
    }
    ...
    public static void IntakeSpeed_Motor(double INTAKE_MOTOR_RPM) {
        INTAKE_MOTOR_LEFT.getPIDController().setReference(INTAKE_MOTOR_RPM, ControlType.kVelocity);   
    }

    public static void IntakeSpeed_Motor_0() {
